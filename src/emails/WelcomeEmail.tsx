...
const WelcomeEmail = ({ name, url }: { name: string; url: string }) => {
	return (
		<Html>
			<Head />
			<Preview>Welcome to CourseNest - Your learning journey begins!</Preview>
			<Body style={main}>
				<Container style={container}>
					<Section style={content}>
						<Heading style={heading}>Welcome to CourseNest!</Heading>
						...
						<Hr style={hr} />
						<Text style={text}>With CourseNest, you can:</Text>
						<ul style={list}>
					...
					<Section style={footer}>
						<Text style={footerText}>
							© {new Date().getFullYear()} CourseNest, Inc. All Rights Reserved.
						</Text>
					</Section>
				</Container>
			</Body>
